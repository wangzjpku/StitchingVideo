...
#if 0
	filename.push_back("rtsp://169.254.49.14:554/user=admin&password=&channel=1&stream=0.sdp?real_stream?tcp");
	filename.push_back("rtsp://169.254.49.12:554/user=admin&password=&channel=1&stream=0.sdp?real_stream?tcp");
	filename.push_back("rtsp://169.254.49.11:554/user=admin&password=&channel=1&stream=0.sdp?real_stream?tcp");
	filename.push_back("rtsp://169.254.49.13:554/user=admin&password=&channel=1&stream=0.sdp?real_stream?tcp");
#else
	filename.push_back("./TestNew5/1.mp4");
	filename.push_back("./TestNew5/2.mp4");
	filename.push_back("./TestNew5/3.mp4");
	filename.push_back("./TestNew5/4.mp4");
#endif 
	for( int i = 0 ; i < num_images ; i++ )
	{
